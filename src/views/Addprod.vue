    ...
    <form @submit.prevent="getFormValues" class="form-addprod row">
      <div class="col-12 col-md-6">
        <div class="form-group">
          <label for="nombre">Nombre <span class="required"/></label>
          <input
            type="text"
            class="form-control"
            id="nombre"
      ...
      <div class="col-12 col-md-6">
        <div class="form-group">
          <label for="precio">Precio <span class="required"/></label>
          <input
            type="number"
            class="form-control"
            id="precio"
      ...
      <div class="col-12 col-md-6">
        <label for="selectCategoria">Categoría <span class="required"/></label>
        <select
          class="form-select"
          id="selectCategoria"
      ...
      <div class="col-12 col-md-6">
        <div class="form-group">
          <label for="stock">Unidades <span class="required"/></label>
          <input
            type="number"
            class="form-control"
            id="stock"
      ...
      <div class="col-12">
        <div class="form-group">
          <label for="descripcion">Descripción <span class="required"/></label>
          <textarea
            class="form-control"
            id="descripcion"
            rows="3"
      ...
      <div class="col-12 my-4">
        <div class="form-group row">
          <div class="col-12 col-md-4 d-flex flex-column pe-5">
            <label for="imagen">Imagen <span class="required"/></label>
            <div
      ...
      <div class="col-12 col-md-4 mt-4">
        <button type="reset" class="col-12 btn btn-secondary">
          Cancelar
        </button>
      </div>
...
export default {
  ...
  methods: {
    ...
    getFormValues(values) {
      ...
      if (errors.length === 0) this.addProd();
    },
